...
<div class="buy-content">
    <div class="main1 fl">
        <div class="market font1">卖方市场</div>
        <div class="clearfix">
            <div class="left-con fl">
                <div class="Part-One">
                    <div class="clearfix producttype">
                        ...
                        <p class="fl amount font2">票据金额：<input type="text" class="box1"
                                                               id="positiveStartMoney"><i></i><input type="text"
                                                                                                     class="box1"
                                                                                                     id="positiveEndMoney">
                        </p>
                    ...
                    <div class="clearfix bill">
                        ...
                        <p class="fl font2 l" style="margin-left:43px"> 票源地址：</p><input type="text" id="address"
                                                                                        class="box1">
                    ...
                    <input value="查询" type="button" id="select" class="button">
                </div>
                <div class="Part-Two">
                    <table>
                        <thead>
            ...
            <div class="right-con fr">
                <div class="Chart clearfix">
                    ...
                    <div class="inbtn fr" style="font-size:0">
                        <input type="button" value="日线" class="button">
    ...
    (function ($) {
        ...
        function ajax(pageType) {
            ...
            $.ajax({
                ...
                success: function (sellJSON) {
                    if (n < sellJSON.length && pageType == "next") { //上一页
                        n += num;
                        m += num;
                        ...
                        n = sellJSON.length + (sellJSON.length % num) - 1;
                        m = sellJSON.length + (sellJSON.length % num) - 11;
                    }
                    /*判断页面总数*/
                    if (sellJSON.length % num == 0) {
                        count = parseInt(sellJSON.length / num);
                    } else {
                        count = parseInt((sellJSON.length / num) + 1);
                    }
                    /*计算当前页面*/
                    if (n % num == 0) {
                    ...
                    $.each(sellJSON, function (index, positive) {
                        if (index >= m && index < n) {
                            ...
                            ohtml += "<td class='font4'>3.1</td>" +
                                ...
                                "<td class='font4'>" + positive.surplus + "天</td>" +
                    ...
                    thtml += " <span style='margin-right:10px;color: white;' id='pageCount' >共" + count + "页</span>" +
                        ...
                        "<span style='margin-right:10px;color: white;' id='pageNow'>共" + sellJSON.length + "条记录</span>";
                    $(".tbody").html(ohtml);
                    $(".count").html(thtml);
                }
            });
...
<script type="text/javascript">
    ...
    $("#select").click(function () {
        ...
        var positiveAddress = $("#positiveAddress").val();
        ...
        var m = -num;
        var pageNow = 0;
        console.log("posiType:" + posiType + "/acceType:" + acceType + "/deadLine:" + deadLine + "/positiveStartMoney:" + positiveStartMoney + "/positiveEndMoney:" + positiveEndMoney + "/inquiryPerson:" + inquiryPerson +
            "/address:" + address);
        function ajax(pageType) {
            var ohtml = "";
            var thtml = "";
