    ...
    <div class="main1">
        <div class="InDialogueStore">
            <div class="clearfix">
                ...
                <div class="Part-Two">
                    <table>
                        ...
                        <c:forEach items="${lists}" var="process_deal">
                            <tr>
                                <td class="font3">${process_deal.positiveNumber}</td>
                                <td class="font3">${process_deal.positiveType}</td>
                                <td class="font4">${process_deal.transactionType}</td>
                                <td class="font4">3</td>
                                <td class="font4">${process_deal.positiveTime}</td>
                                <td class="font4">${process_deal.acceptor}</td>
                                <td class="font3">${process_deal.positiveAddress}</td>
                                <td class="font3 state0">${process_deal.state}</td>
                                <td class="font3">${process_deal.userId}</td>
                            </tr>
                        </c:forEach>
                        <tr>
                            <td class="font3">1</td>
            ...
            <div class="InDial">
                ...
                <div class="radiu">
                    <ul class="clearfix">
                        <li class="radiu1 fl"></li>
                        <li class="radiu2 fl"></li>
                        <li class="radiu3 fl"></li>
                    </ul>
                </div>
                <div class="itcm">
                    <span class="itcm1">已背书</span>
                    <span class="itcm2">已签收</span>
                </div>
                <div class="danger">
                    <span class="danger1">（或已撤回）</span>
                    <span>（或已拒收）</span>
                </div>
                <div class="time">
                    签收倒计时：<span>03:</span><span>00</span>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    (function ($) {
        ...
        function ajax(pageType) {
            ...
            $.ajax({
                type: "POST",
                url: "${ctx}/transaction/getJSONByProcess_deal",
                dataType: "JSON",
                success: function (tranJSON) {
                    ...
                    $.each(tranJSON, function (index, positive) {
                        if (index >= m && index < n) {
                            ...
                            ohtml += "<td class='font3'>" + positive.positiveAddress + "</td><td class='font3 state3'>交易中</td>" +
