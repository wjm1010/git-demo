...
<body>
	...
	<header>
			<ul class=" header-left fl">
				...
				<li  class="active"><a href="${ctx}/automatic_deal/automatic_deal"><i class="iconfont icon-shouye_shouye"></i>自动交易</a></li>
	...
	<div class="user-sidebar" id="user-sidebar">
		<ul>
			<li class="user-mes active">
				<a href="javascript:;" _link="${ctx}/automatic_deal/sell_market_made" class="">卖方市场</a>
			</li>
			<li>
				<a href="javascript:;" _link="${ctx}/automatic_deal/buy_market_made" class="">买方市场</a>
			</li>
		</ul>
	</div>
	<!-- 右侧侧边栏结束 -->
	...
	<div class="right-main">
		<div class="right-content" id="right-content">
			<iframe id="main" name="main" frameborder="0" scrolling="yes" src="${ctx}/automatic_deal/sell_market_made"></iframe>
		</div>
	</div>
	<!-- 主体内容结束 -->
</body>
