...
<body>
	...
	<header>
		<ul class=" header-left fl">
			...
			<li class="active"><a href="${ctx}/mes_manage/mes_manage"><i class="iconfont icon-yonghu"></i>信息管理</a></li>
	...
	<div class="user-sidebar" id="user-sidebar">
		<ul>
			<li class="user-mes active">
				<a href="javascript:;" _link="${ctx}/mes_manage/company_mes_weihu" class="">公司信息维护</a>
			</li>
			<li>
				<a href="javascript:;" _link="${ctx}/mes_manage/log_check" class="">日志查看</a>
			</li>
			<li>
				<a href="javascript:;"  _link="${ctx}/mes_manage/credit_list_manage" class="operate-count">授信名单管理</a>
			</li>
		</ul>
	</div>
	<!-- 右侧侧边栏结束 -->
	...
	<div class="right-main">
		<div class="right-content" id="right-content">
			<iframe id="main" name="main" frameborder="0" scrolling="yes" src="${ctx}/mes_manage/company_mes_weihu"></iframe>
		</div>
	</div>
	<!-- 主体内容结束 -->
</body>
