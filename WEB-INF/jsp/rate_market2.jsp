...
<div class="rate-market">
    ...
    <!-- 产品类型结束 -->
    <!-- 承兑人类型开始 -->
    <div class="company-acceptor-type">
        <div class="acceptor-type-title">
            <h3>企业承兑人类型</h3>
        </div>
        <div class="acceptor-type-content">
            <div class="item center-company">
                <p class="name">中央企业</p>
                <div class="number">
                    <p>3.85</p>
                    <p>
            ...
            <div class="item state-nation-company">
                <p class="name">地方国企</p>
                <div class="number">
                    <p>3.85</p>
                    <p>
            ...
            <div class="item privately-company">
                <p class="name">民营企业</p>
                <div class="number">
                    <p>3.85</p>
                    <p>
